...
vlog -work work PLL_ctrl_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax PLL_ctrl_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.PLL_ctrl_tb work.glbl
